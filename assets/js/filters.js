...
function createCustomDropdown(elementId, options, counts, placeholder, onChange, specialMapping) {
    ...
    menu.addEventListener('click', function(event) {
        ...
        if (value === '') {
            ...
            const selectedItems = Array.from(menu.querySelectorAll('.custom-dropdown-item.selected'))
            ...
            if (selectedItems.length === 0) {
                ...
                const selectedValues = selectedItems.map(item => {
                    ...
                    return specialMapping && specialMapping[itemValue] ? specialMapping[itemValue] : itemValue;
                });
                ...
                if (originalSelect) {
                    ...
                    if (selectedValues.length > 1) {
                        ...
                        selectedText.textContent = target.querySelector('.custom-dropdown-item-label').textContent;
                    }
